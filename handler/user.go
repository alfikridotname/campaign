...
func (h *userHandler) UploadAvatar(c *gin.Context) {
	...
	if err != nil {
		...
		response := helper.APIResponse("Failed to upload avatar image", http.StatusBadRequest, false, data)
		c.JSON(http.StatusBadRequest, response)
		return
	}
	...
	response := helper.APIResponse("Avatar successfuly uploaded", http.StatusOK, true, data)
	c.JSON(http.StatusOK, response)
}
